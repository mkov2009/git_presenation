...
const Errors = require("../api/errors/git-presentation-error.js");
...
const logger = LoggerFactory.get("GitPresentationAbl");

class GitPresentationAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuGit",
        typeCode: "uu-git-presentationg01",
        location: location,
...
module.exports = new GitPresentationAbl();
